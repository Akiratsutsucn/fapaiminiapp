...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'articles', name: 'Articles', component: () => import('@/views/article/ArticleList.vue'), meta: { title: '文章管理', roles: ADMIN_ONLY } },
            { path: 'banners', name: 'Banners', component: () => import('@/views/banner/BannerList.vue'), meta: { title: '横幅管理', roles: ADMIN_ONLY } },

...
const cards = ref([
  { label: '总房源数', value: 0, cityBreakdown: [] as any[] },
  { label: '今日新增', value: 0, cityBreakdown: [] as any[] },
  { label: '即将开拍', value: 0, cityBreakdown: [] as any[] },
  { label: '捡漏房源', value: 0, cityBreakdown: [] as any[] },
  { label: '昨日上架', value: 0, cityBreakdown: [] as any[] },
  { label: '昨日成交', value: 0, cityBreakdown: [] as any[] },
  { label: '注册用户', value: 0, cityBreakdown: [] as any[] },
  { label: '代理商', value: 0, cityBreakdown: [] as any[] },
  { label: '待处理需求', value: 0, cityBreakdown: [] as any[] },
  { label: '待处理留言', value: 0, cityBreakdown: [] as any[] },
  { label: '已成交', value: 0, cityBreakdown: [] as any[] },

...
Page({
    ...
    async loadProperty(id) {
        try {
            ...
            this.setData({
                ...
                discount: (property.court_discount_rate && property.court_discount_rate < 1) ? (0, format_1.formatDiscount)(property.court_discount_rate) : '--',
                discountLabel: '折扣',
    ...
    onRiskTap(e) {
        ...
        const tag = (_b = (_a = this.data.property) === null || _a === void 0 ? void 0 : _a.risk_tags) === null || _b === void 0 ? void 0 : _b[idx];
        if (!tag)
            return;
        wx.showModal({
            title: tag.label,

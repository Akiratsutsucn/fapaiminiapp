...
Page({
    ...
    onDealPriceInput(e) { this.setData({ dealPrice: e.detail.value }); if (this.data.calculated)
        this.doCalc(); },
    onAreaInput(e) { this.setData({ area: e.detail.value }); if (this.data.calculated)
        this.doCalc(); },
    onAgentRateInput(e) { this.setData({ agentRatePct: e.detail.value }); if (this.data.calculated)
        this.doCalc(); },
    onToggleFirstHome(e) { this.setData({ isFirstHome: e.currentTarget.dataset.value === 'true' }); if (this.data.calculated)
        this.doCalc(); },
    onToggleYears(e) { this.setData({ overTwoYears: e.currentTarget.dataset.value === 'true' }); if (this.data.calculated)
        this.doCalc(); },
    onToggleUnique(e) { this.setData({ isUnique: e.currentTarget.dataset.value === 'true' }); if (this.data.calculated)
        this.doCalc(); },
    onCalculate() {
